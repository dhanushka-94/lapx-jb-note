...
<div class="min-h-screen flex flex-col justify-center items-center pt-6 sm:pt-0 bg-gradient-to-b from-indigo-50 to-white">
    <div class="w-full sm:max-w-md mt-6 mb-8 text-center">
        <h1 class="text-3xl font-extrabold text-indigo-700 flex items-center justify-center">
            <i class="fas fa-laptop-medical text-3xl mr-3"></i>
    ...
    <div class="w-full sm:max-w-md">
        <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 btn-effect">
            ...
            <div class="mt-6 text-center">
                ...
                <div class="mt-2 flex justify-center space-x-4">
                    ...
                    <i class="fas fa-print text-indigo-700"></i>
                </div>
            </div>
        </div>
    </div>
